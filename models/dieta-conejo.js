...
const DietaConejoSchema = Schema( {
...
DietaConejoSchema.methods.toJSON = function () {
    
    const { _id, ...dietaConejo } = this.toObject();
    dietaConejo.idDieta = _id;
    return dietaConejo;
}

module.exports = model( 'dieta_conejo', DietaConejoSchema );
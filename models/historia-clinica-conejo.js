...
const HistoriaClinicaConejoSchema = Schema( {
...
HistoriaClinicaConejoSchema.methods.toJSON = function () {
    const { _id, ...historia } = this.toObject();
    historia.idHistoria = _id;
    return historia;
}

module.exports = model( 'historia_clinica_conejo', HistoriaClinicaConejoSchema );
...
const DietaMascotaSchema = Schema( {
...
DietaMascotaSchema.methods.toJSON = function () {
    
    const { _id, ...dietaMascota } = this.toObject();
    dietaMascota.idDieta = _id;
    return dietaMascota;
}

module.exports = model( 'dieta_mascota', DietaMascotaSchema );
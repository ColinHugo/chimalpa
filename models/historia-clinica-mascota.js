...
const HistoriaClinicaMascotaSchema = Schema( {
...
HistoriaClinicaMascotaSchema.methods.toJSON = function () {
    const { _id, ...historia } = this.toObject();
    historia.idHistoria = _id;
    return historia;
}

module.exports = model( 'historia_clinica_mascota', HistoriaClinicaMascotaSchema );
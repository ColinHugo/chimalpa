...
const DietaCaballoSchema = Schema( {
...
DietaCaballoSchema.methods.toJSON = function () {
    
    const { _id, ...dietaCaballo } = this.toObject();
    dietaCaballo.idDieta = _id;
    return dietaCaballo;
}

module.exports = model( 'dieta_caballo', DietaCaballoSchema );